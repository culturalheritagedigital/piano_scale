...
if audio:
    ...
    if numpy_array is not None:
        ...
        if data_ok:
            ...
            st.write("Inharmonizitätskoeffizient $\delta$ nach Young:  ", np.round(B_to_delta(B,1),2), " Cent ($\delta_{Laible}$", delta_soll_laible[key_num-1], "$\delta_{Fenner}$", delta_soll_fenner[key_num-1], ")")
